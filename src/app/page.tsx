          ...
          <div className="flex flex-wrap items-center justify-between gap-5">
            <div className="space-y-3">
              ...
              <p className="max-w-2xl text-sm leading-relaxed text-slate-300 sm:text-base">
                ...
                with Sketch & Guess now, then jump into STOP, Spyfall, Most Likely, Truth or Dare,
                and Emoji Translator.
              </p>
            </div>
            ...
            <div className="flex w-full flex-col gap-2 sm:w-auto">
              <Link
                ...
                className="neon-button inline-flex items-center justify-center gap-2 rounded-xl bg-white px-4 py-2 text-sm font-semibold text-slate-900 transition hover:bg-violet-100"
              >
                Start Sketch & Guess
              ...
              <Link
                href="/builder-tools"
                className="neon-button inline-flex items-center justify-center gap-2 rounded-xl border border-white/20 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/10"
              >
